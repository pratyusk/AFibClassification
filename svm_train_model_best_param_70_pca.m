...
svm_model = fitcsvm(x_train_pca, y_train, 'KernelFunction', 'linear', 'PolynomialOrder', [], 'KernelScale', 'auto', 'BoxConstraint', C, 'Standardize', 1, 'Cost', [0, 1 ; w, 0]);
...
for i = 1:length(y_test)
   ...
   test_pred_y(i) = predict(svm_model, x_test_pca(i,:));       
end
%% result
y_test = y_test';
