...
% test with LDA
[test_acc_PCA, train_acc_PCA, SVM_Model_PCA_normal] = lda_classifier(Phi_train_PCA_normal,labels_train,'linear',1,1,Phi_test_PCA_normal, labels_test);
[test_acc_normal, train_acc_normal, SVM_Model_normal] = lda_classifier(Phi_train_non_PCA_normal,labels_train,'linear',1,1,Phi_test_non_PCA_normal, labels_test);
[test_acc_not_normal, train_acc_not_normal, SVM_Model_not_normal] = lda_classifier(Phi_train_non_PCA_not_normal,labels_train,'linear',1,1,Phi_test_non_PCA_not_normal, labels_test);
% figure();
